...
import com.adidas.challenge.data.output.ModelError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ModelError> arguments(HttpServletRequest request,
    ...
    public ResponseEntity<ModelError> duplicate(HttpServletRequest request,
